...
Partial Public Class DataSet2
    ...
    Partial Public Class DetallesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function AddDetallesRow(ByVal Clave As String, ByVal Terminado As String, ByVal Frase As String) As DetallesRow
            Dim rowDetallesRow As DetallesRow = CType(Me.NewRow, DetallesRow)
            Dim columnValuesArray() As Object = New Object() {Clave, Terminado, Frase}
    ...
    Partial Public Class DetallesRow
        ...
        Public Property Frase() As String
            Get
                Try
                    Return CType(Me(Me.tableDetalles.FraseColumn), String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Frase' in table 'Detalles' is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableDetalles.FraseColumn) = value
            End Set
        End Property
        ...
        Public Function IsFraseNull() As Boolean
            Return Me.IsNull(Me.tableDetalles.FraseColumn)
        End Function

        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Sub SetFraseNull()
            Me(Me.tableDetalles.FraseColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
