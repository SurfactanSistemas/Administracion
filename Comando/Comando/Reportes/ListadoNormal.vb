...
Public Class ListadoNormal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Comando.ListadoNormal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoNormal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoNormal = New ListadoNormal()
        rpt.Site = Me.Site
        Return rpt
    End Function
