...
Public Class ReporteEtiContra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio.ReporteEtiContra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteEtiContra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteEtiContra = New ReporteEtiContra()
        rpt.Site = Me.Site
        Return rpt
    End Function
