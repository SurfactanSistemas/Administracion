...
Public Class ReporteEtiContraII
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio.ReporteEtiContraII.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteEtiContraII
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteEtiContraII = New ReporteEtiContraII()
        rpt.Site = Me.Site
        Return rpt
    End Function
