...
Public Class PlanillaEnsayosMP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio.PlanillaEnsayosMP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPlanillaEnsayosMP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PlanillaEnsayosMP = New PlanillaEnsayosMP()
        rpt.Site = Me.Site
        Return rpt
    End Function
