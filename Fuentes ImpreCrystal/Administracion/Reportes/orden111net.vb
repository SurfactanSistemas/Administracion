...
Public Class orden111net
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.orden111net.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DireccionI() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedorden111net
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As orden111net = New orden111net()
        rpt.Site = Me.Site
        Return rpt
    End Function
