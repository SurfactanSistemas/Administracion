...
Public Class recuired_specs_po_nro_net
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "recuired specs po nro net.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.recuired specs po nro net.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrecuired_specs_po_nro_net
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As recuired_specs_po_nro_net = New recuired_specs_po_nro_net()
        rpt.Site = Me.Site
        Return rpt
    End Function
