...
Public Class listaespepdfnet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.listaespepdfnet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlistaespepdfnet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listaespepdfnet = New listaespepdfnet()
        rpt.Site = Me.Site
        Return rpt
    End Function
