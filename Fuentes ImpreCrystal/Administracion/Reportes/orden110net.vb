...
Public Class orden110net
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.orden110net.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedorden110net
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As orden110net = New orden110net()
        rpt.Site = Me.Site
        Return rpt
    End Function
