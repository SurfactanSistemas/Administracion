...
Public Class Listado_PT_SinVentas
    ...
    Private Sub btn_Aceptar_Click(sender As Object, e As EventArgs) Handles btn_Aceptar.Click
        ...
        For i = 0 To 6
            ...
            SQLCnslt = "SELECT Entradas, Salidas, Codigo, Descripcion FROM Terminado WHERE Codigo >= '" & txt_DesdeTer.Text & "' AND Codigo <= '" & txt_HastaTer.Text & "'"
            ...
            If TablaTer.Rows.Count > 0 Then
                ...
                For Each RowTer As DataRow In TablaTer.Rows
                    ...
                    If WStock > 0 Then
                        ...
                        TablaCalculo.Rows(fila).Item("Codigo") = UCase(RowTer.Item("Codigo"))
            ...
            For Each RowCalculo As DataRow In TablaCalculo.Rows
                ...
                Dim WStock As String = IIf(IsDBNull(RowCalculo.Item("Stock")), "", RowCalculo.Item("Stock"))
