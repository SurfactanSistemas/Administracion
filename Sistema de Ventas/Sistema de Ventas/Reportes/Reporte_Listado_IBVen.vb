...
Public Class Reporte_Listado_IBVen
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_Listado_IBVen.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Ventas.Reporte_Listado_IBVen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Listado_IBVen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Listado_IBVen = New Reporte_Listado_IBVen()
        rpt.Site = Me.Site
        Return rpt
    End Function
