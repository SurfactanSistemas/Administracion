...
Public Class ReporteFliaMP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Ventas.ReporteFliaMP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteFliaMP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteFliaMP = New ReporteFliaMP()
        rpt.Site = Me.Site
        Return rpt
    End Function
