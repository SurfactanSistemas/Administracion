...
Public Class ReporteSaldoCtaCte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Ventas.ReporteSaldoCtaCte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteSaldoCtaCte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteSaldoCtaCte = New ReporteSaldoCtaCte()
        rpt.Site = Me.Site
        Return rpt
    End Function
