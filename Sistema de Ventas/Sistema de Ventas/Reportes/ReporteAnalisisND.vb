...
Public Class ReporteAnalisisND
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Ventas.ReporteAnalisisND.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteAnalisisND
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteAnalisisND = New ReporteAnalisisND()
        rpt.Site = Me.Site
        Return rpt
    End Function
