...
Public Class ReporteIndiceINCs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.ReporteIndiceINCs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteIndiceINCs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteIndiceINCs = New ReporteIndiceINCs()
        rpt.Site = Me.Site
        Return rpt
    End Function
