...
Public Class NuevoSACCaratula
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.NuevoSACCaratula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNuevoSACCaratula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements ICachedReport.CreateReport
        Dim rpt As NuevoSACCaratula = New NuevoSACCaratula()
        rpt.Site = Me.Site
        Return rpt
    End Function
