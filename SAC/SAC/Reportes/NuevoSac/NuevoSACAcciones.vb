...
Public Class NuevoSACAcciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.NuevoSACAcciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNuevoSACAcciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NuevoSACAcciones = New NuevoSACAcciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
