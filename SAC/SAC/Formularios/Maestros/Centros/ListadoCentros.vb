Public Class ListadoCentros : Implements INuevoCentro
    ...
    Private Sub dgvTIpos_CellMouseDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgvCentros.CellMouseDoubleClick
    ...
    Private Sub txtCodigo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCodigo.KeyDown
        ...
        If e.KeyData = Keys.Enter Then
            ...
            Dim WTipo As DataRow = Query.GetSingle("SELECT Codigo FROM CentroSac WHERE Codigo = '" & txtCodigo.Text & "'")
    ...
    Private Sub dgvTIpos_RowHeaderMouseDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgvCentros.RowHeaderMouseDoubleClick
