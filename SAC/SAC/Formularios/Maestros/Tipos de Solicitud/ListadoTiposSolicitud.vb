Public Class ListadoTiposSolicitud : Implements INuevoTipoSolicitud
    ...
    Private Sub txtFiltrar_KeyPress(ByVal sender As Object, ByVal e As KeyPressEventArgs) Handles txtFiltrar.KeyPress
        Try
            Dim tabla = CType(dgvTIpos.DataSource, DataTable)
    ...
    Private Sub dgvTIpos_CellMouseDoubleClick(ByVal sender As Object, ByVal e As DataGridViewCellMouseEventArgs) Handles dgvTIpos.CellMouseDoubleClick
    ...
    Private Sub txtCodigo_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles txtCodigo.KeyDown
        ...
        If e.KeyData = Keys.Enter Then
            ...
            Dim WTipo As DataRow = GetSingle("SELECT Codigo FROM TipoSac WHERE Codigo = '" & txtCodigo.Text & "'")
    ...
    Private Sub dgvTIpos_RowHeaderMouseDoubleClick(ByVal sender As Object, ByVal e As DataGridViewCellMouseEventArgs) Handles dgvTIpos.RowHeaderMouseDoubleClick
