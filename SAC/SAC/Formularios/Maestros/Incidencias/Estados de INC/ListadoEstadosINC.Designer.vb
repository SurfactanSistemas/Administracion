...
<DesignerGenerated()> _
Partial Class ListadoEstadosINC
    Inherits Form
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Listado de Estados de INC"
        '
        'Label1
        '
        ...
        Me.btnEditar.Text = "Editar Estado"
