...
Public Class ListadoEstaClienteLineaImpo
    ...
    Private Sub ListadoEstaClienteLinea_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtDesdeCliente.Text = "A00000"
        txtHastaCliente.Text = "Z99999"
    ...
    Private Sub txtdesdecliente_KeyPress(ByVal sender As Object, _
                   ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtDesdeCliente.KeyPress
    ...
    Private Sub txthastacliente_KeyPress(ByVal sender As Object, _
                   ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtHastaCliente.KeyPress
    ...
    Private Sub Proceso()
        ...
        '    tabla = SQLConnector.retrieveDataTable("buscar_estadistica_productos", 0, 9999, 0, 9999, 0, 9999, txtDesdeCliente.Text, txtHastaCliente.Text, "", "Z99999", txtDesde, txtHasta)
        ...
        '    Dim tabla As DataTable
        '    tabla = SQLConnector.retrieveDataTable("buscar_estadistica_productosII", 0, 9999, 0, 9999, 0, 9999, txtDesdeCliente.Text, txtHastaCliente.Text, "", "Z99999", txtDesde, txtHasta)
        ...
        txtUno = "{Estadistica.Cliente} in " + x + txtDesdeCliente.Text + x + " to " + x + txtHastaCliente.Text + x
        txtDos = " and {Estadistica.OrdFecha} in " + x + txtDesde + x + " to " + x + txtHasta + x
        txtFormula = txtUno + txtDos

        txtFormula &= " And {Estadistica.Numero} in 800000 to 899999"


        Dim viewer As New ReportViewer("Listado de Ventas de Exportación", Globals.reportPathWithName("WEstaClienteLineaImponet.rpt"), txtFormula)
    ...
    Private Sub ListadoEstaClienteLineaImpo_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        txtDesdeCliente.Focus()
    End Sub
End Class