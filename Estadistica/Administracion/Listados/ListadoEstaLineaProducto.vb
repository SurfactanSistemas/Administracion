...
Public Class ListadoEstaLineaProducto
    ...
    Private Sub ListadoEstaLineaProducto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    '               ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtAyuda.KeyPress
    ...
    Private Sub Proceso()
        ...
        Dim viewer As New ReportViewer("Listado de Estadisticas de Ventas por Linea y Producto", Globals.reportPathWithName("WEstaLineaNet.rpt"), txtFormula)
