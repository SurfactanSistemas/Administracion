...
Public Class ListadoEstaVendedorLinea
    ...
    Private Sub ListadoEstaVendedorLinea_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Proceso()
        ...
        Dim WReporte As String = "WEstaVendedorLineaNet.rpt"

        If Vendedor.permisos <> 99 Then
            WReporte = "WEstaVendedorLineaNetVendedor.rpt"
        End If

        If UCase(Globals.empresa) = "SURFACTAN" Then
            WReporte = "WEstaVendedorLineaNet.rpt"
    ...
    Private Sub ListadoEstaVendedorLinea_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
