...
Public Class ListadoEstaProductoCliente
    ...
    Private Sub ListadoEstaProductoLinea_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Proceso()
        ...
        If TipoCosto.SelectedIndex = 0 Then
            ...
            tabla = SQLConnector.retrieveDataTable("buscar_estadistica_productos", 0, 9999, 0, 9999, 0, 9999, "", "Z99999", txtDesdeTerminado.Text, txtHastaTerminado.Text, txtDesde, txtHasta)
        ...
        txtUno = "{Estadistica.Articulo} in " + x + txtDesdeTerminado.Text + x + " to " + x + txtHastaTerminado.Text + x
        txtDos = " and {Estadistica.OrdFecha} in " + x + txtDesde + x + " to " + x + txtHasta + x
        txtFormula = txtUno + txtDos


        Dim viewer As New ReportViewer("Listado de Estadistica por Producto y Cliente", Globals.reportPathWithName("WEstaProductoClientenet.rpt"), txtFormula)
