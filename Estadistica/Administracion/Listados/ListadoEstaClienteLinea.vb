...
Public Class ListadoEstaClienteLinea
    ...
    Private Sub Proceso()
        ...
        Dim viewer As New ReportViewer("Listado de Estadistica por Cliente y Linea", Globals.reportPathWithName("WEstaClienteLineanet.rpt"), txtFormula)
