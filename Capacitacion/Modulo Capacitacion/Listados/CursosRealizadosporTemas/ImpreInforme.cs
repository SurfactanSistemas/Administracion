    ...
    public partial class ImpreInforme : Form
    {
        ...
        private void ImpreInforme_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < filas - 1; i++)
            {
                ...
                (dr[0].ToString(), dr[1].ToString(), dr[2].ToString(), dr[3].ToString(), dr[4].ToString(), dr[5].ToString(), dr[6], dr[7].ToString(), dr[8].ToString(), dr[9].ToString(), dr[10].ToString(), dr["Dni"]);
            }
