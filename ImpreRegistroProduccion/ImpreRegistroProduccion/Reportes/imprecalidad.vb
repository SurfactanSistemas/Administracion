...
Public Class imprecalidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ImpreRegistroProduccion.imprecalidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedimprecalidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As imprecalidad = New imprecalidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
