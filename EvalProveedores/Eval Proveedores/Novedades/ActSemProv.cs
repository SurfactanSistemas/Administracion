    ...
    public partial class ActSemProv : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                //LISTO LOS PROVEEDORES DE TIPO 1
                //dtProveedores = PBOL.ListaTipo(1);
                ...
                {
                    dtInforme = ESBOL.ListaInforme(OrdFechaDesde, ordFechaHAsta, _Empresa, Tipo);
                    CargarInforme(dtInforme);
                }
        ...
        private void CargardtInformeMuestra()
        {
            ...
            dtEvaluacion.Columns.Add("CantidadLibGuardada", typeof(int));
            dtEvaluacion.Columns.Add("CantidadDevGuardada", typeof(int));
             * */
        }
        ...
        private void ArmarCategoria(string Calidad)
        {
        ...
        private void DGV_EvalSemProve_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            foreach(string _Empresa in _Empresas)
            {
                dtInformeProve = ESBOL.ListaInformeProve(OrdFechaDesde, ordFechaHAsta, _Empresa, 1, Prove);
                CargarInformeProve(dtInformeProve);
            }
