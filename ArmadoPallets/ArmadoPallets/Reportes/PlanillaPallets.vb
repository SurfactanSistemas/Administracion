...
Public Class PlanillaPallets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ArmadoPallets.PlanillaPallets.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPlanillaPallets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PlanillaPallets = New PlanillaPallets()
        rpt.Site = Me.Site
        Return rpt
    End Function
