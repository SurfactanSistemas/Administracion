...
Public Class EtiPreenvasadoGral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CentroImpresion.EtiPreenvasadoGral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiPreenvasadoGral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiPreenvasadoGral = New EtiPreenvasadoGral()
        rpt.Site = Me.Site
        Return rpt
    End Function
