...
Public Class etinuevacolorante
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CentroImpresion.etinuevacolorante.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedetinuevacolorante
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As etinuevacolorante = New etinuevacolorante()
        rpt.Site = Me.Site
        Return rpt
    End Function
