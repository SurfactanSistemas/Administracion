...
namespace HojaRuta.Reportes {
    public class hojarutanuevo : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HojaRuta.Reportes.hojarutanuevo.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedhojarutanuevo : Component, ICachedReport {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        public virtual ReportDocument CreateReport() {
            hojarutanuevo rpt = new hojarutanuevo();
            rpt.Site = Site;
            return rpt;
        }
