...
Public Class FormOrganizer
    ...
    Public Sub compactOrganize()
        ...
        separationBetweenControlsAndButtons = 100
    ...
    Private Function organizeButtons(ByVal top As Integer)
        Const NUEVA_POSICION_BOTONES = 380 + 60
        createActionButtons()
        ...
        For Each button As CustomButton In buttonsTop
            setButtonPosition(button, NUEVA_POSICION_BOTONES, left)
            left += buttonWidth + separation
        Next

        left = leftMargin
        For Each button As CustomButton In buttonsBottom
            setButtonPosition(button, NUEVA_POSICION_BOTONES + button.Height + separation, left)
            left += buttonWidth + separation
        Next
    ...
    Private Sub addControlerButtons(ByVal top As Integer, ByVal left As Integer)
        Const NUEVA_POSICION_NEVEGADOR = 375 + 60
        ...
        container.Top = NUEVA_POSICION_NEVEGADOR 'top - separation
    ...
    Private Sub organizeQueryControllers(ByVal top As Integer)
        Const NUEVA_POSICION_CONSULTAS = 450 + 60
        ...
        If usingQueryText Then
            ...
            queryText.Top = NUEVA_POSICION_CONSULTAS 'top + separation
            top = queryText.Top
        ...
        queryList.Height = 100 'realQueryListHeight
        queryList.Top = NUEVA_POSICION_CONSULTAS + 30 'top + queryTextHeight() + separation
        ...
        If queryFunctions.Count > 1 Then
            ...
            selectionList.Height = 100 'Math.Min(Math.Round(listQueryHeight / 2), maxHeight - formNormalHeight - compactHeightConstant)
            selectionList.Top = NUEVA_POSICION_CONSULTAS 'top + separation
