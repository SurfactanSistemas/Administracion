...
Public Class WListadoRecibos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.WListadoRecibos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWListadoRecibos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WListadoRecibos = New WListadoRecibos()
        rpt.Site = Me.Site
        Return rpt
    End Function
