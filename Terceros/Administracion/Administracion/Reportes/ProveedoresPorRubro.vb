...
Public Class ProveedoresPorRubro
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ProveedoresPorRubro.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.ProveedoresPorRubro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProveedoresPorRubro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProveedoresPorRubro = New ProveedoresPorRubro()
        rpt.Site = Me.Site
        Return rpt
    End Function
