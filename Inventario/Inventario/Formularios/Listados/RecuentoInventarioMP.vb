...
Public Class RecuentoInventarioMP : Implements IAyudaMP

    Private WTargetAyuda As Control

    Private Sub RecuentoInventarioMP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub

    Public Sub AsignarMP(ByVal _Codigo As Object, ByVal _Descripcion As Object) Implements IAyudaMP.AsignarMP
    ...
    Private Sub RecuentoInventarioMP_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        txtDesde.Focus()
    End Sub
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Try
            ...
            Dim rpt As New ReporteRecuentoInventarioMP
    ...
    Private Function _TraerDatos() As SqlDataAdapter
        ...
        Dim cm As SqlCommand = New SqlCommand("SELECT i.Clave, i.Articulo, a.Descripcion, i.Numero, i.Cantidad, i.Lote, i.Talon, i.Observaciones, i.Ubicacion, Empresa = '" & WEmpresa & "' FROM Inventario i LEFT OUTER JOIN Articulo a ON a.Codigo = i.Articulo WHERE i.Tipo = 'M' AND i.Articulo BETWEEN '" & txtDesde.Text & "' AND '" & txtHasta.Text & "' ORDER BY i.Clave")
