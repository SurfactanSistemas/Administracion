    ...
    Public Class Conexion
        ...
        Public Shared Function _Login(ByVal Clave As String, ByVal WProceso As Integer) As Boolean
            ...
            Try
                ...
                cn.ConnectionString = Helper._ConectarA(WProceso)
                cn.Open()

                Dim _Emp = DeterminarSegunIDIDBasePara(WProceso)

                Conexion._EmpresaTrabajo = _Emp

                If UCase(_Emp).StartsWith("SURFACTAN") Then

                    EsPellital = False

                ElseIf UCase(_Emp).StartsWith("PELLITAL") Or UCase(_Emp).StartsWith("PELITALL") Then
