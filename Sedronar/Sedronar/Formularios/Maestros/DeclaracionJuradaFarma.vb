...
Public Class DeclaracionJuradaFarma
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Dim WArticuloAProcesar As New DataTable
        ...
        Dim WB As Microsoft.Office.Interop.Excel.Workbook = WExcelApp.Workbooks.Open(Application.StartupPath & "/PlanillaTrimestral-MODELO.xlsx")

        WB.Activate()

        WExcelApp.Visible = False
        ...
        WB.SaveAs(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "/PlanillaTrimestral.xlsx")
