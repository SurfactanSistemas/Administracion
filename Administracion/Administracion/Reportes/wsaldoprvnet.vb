...
Public Class wsaldoprvnet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.wsaldoprvnet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedwsaldoprvnet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As wsaldoprvnet = New wsaldoprvnet()
        rpt.Site = Me.Site
        Return rpt
    End Function
