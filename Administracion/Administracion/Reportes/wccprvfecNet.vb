...
Public Class wccprvfecNet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.wccprvfecNet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedwccprvfecNet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As wccprvfecNet = New wccprvfecNet()
        rpt.Site = Me.Site
        Return rpt
    End Function
