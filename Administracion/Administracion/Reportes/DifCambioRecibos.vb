...
Public Class DifCambioRecibos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.DifCambioRecibos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDifCambioRecibos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DifCambioRecibos = New DifCambioRecibos()
        rpt.Site = Me.Site
        Return rpt
    End Function
