...
Public Class AvisosNoEnviados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.AvisosNoEnviados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAvisosNoEnviados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AvisosNoEnviados = New AvisosNoEnviados()
        rpt.Site = Me.Site
        Return rpt
    End Function
