...
Public Class OrdenPagoComprobanteRetGanancias
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OrdenPagoComprobanteRetGanancias.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.OrdenPagoComprobanteRetGanancias.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MostrarFirma() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TipoFirma() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FirmaAImprimir() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedOrdenPagoComprobanteRetGanancias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenPagoComprobanteRetGanancias = New OrdenPagoComprobanteRetGanancias()
        rpt.Site = Me.Site
        Return rpt
    End Function
