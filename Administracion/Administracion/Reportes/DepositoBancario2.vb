...
Public Class DepositoBancario2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.DepositoBancario2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDepositoBancario2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepositoBancario2 = New DepositoBancario2()
        rpt.Site = Me.Site
        Return rpt
    End Function
