...
Public Class wimpcybresuNet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.wimpcybresuNet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedwimpcybresuNet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As wimpcybresuNet = New wimpcybresuNet()
        rpt.Site = Me.Site
        Return rpt
    End Function
