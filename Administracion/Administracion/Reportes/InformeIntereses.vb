...
Public Class InformeIntereses
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.InformeIntereses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformeIntereses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeIntereses = New InformeIntereses()
        rpt.Site = Me.Site
        Return rpt
    End Function
