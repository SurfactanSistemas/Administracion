...
Public Class OrdenPagoComprobanteIBCABA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OrdenPagoComprobanteIBCABA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.OrdenPagoComprobanteIBCABA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenPagoComprobanteIBCABA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenPagoComprobanteIBCABA = New OrdenPagoComprobanteIBCABA()
        rpt.Site = Me.Site
        Return rpt
    End Function
