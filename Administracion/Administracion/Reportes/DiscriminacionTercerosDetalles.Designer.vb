...
Partial Public Class DiscriminacionTercerosDetalles
    ...
    Partial Public Class DetallesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddDetallesRow(ByVal Corte As String, ByVal Orden As String, ByVal Renglon As String, ByVal Proveedor As String, ByVal Fecha As String, ByVal Cuit As String, ByVal Importe As Double, ByVal Numero As String, ByVal Fecha1 As String, ByVal Banco As String, ByVal Razon As String, ByVal CuitProveedor As String) As DetallesRow
            Dim rowDetallesRow As DetallesRow = CType(Me.NewRow,DetallesRow)
            Dim columnValuesArray() As Object = New Object() {Corte, Orden, Renglon, Proveedor, Fecha, Cuit, Importe, Numero, Fecha1, Banco, Razon, CuitProveedor}
    ...
    Partial Public Class DetallesRow
        ...
        Public Property CuitProveedor() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'CuitProveedor' in table 'Detalles' is DBNull.", e)
                End Try
            End Get
            Set
