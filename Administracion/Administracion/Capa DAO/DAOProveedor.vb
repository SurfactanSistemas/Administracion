    ...
    Public Shared Sub agregarProveedor(ByVal proveedor As Proveedor)
        Try
            ...
            With proveedor
                ...
                WNroIb = .numeroIB
                WPorceIb = Proceso.formatonumerico(.porceIBProvincia)
                WPorceIbCaba = Proceso.formatonumerico(.porceIBCABA)
                WRubro = .RawRubro
