...
Public Class ReporteNotaRetiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Administracion.ReporteNotaRetiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Aclaración() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteNotaRetiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteNotaRetiro = New ReporteNotaRetiro()
        rpt.Site = Me.Site
        Return rpt
    End Function
