    ...
    Private Sub txtProveedor_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles txtProveedor.KeyDown
        ...
        If e.KeyData = Keys.Enter Then
            ...
            Try
                ...
                Dim WProveedor As DataRow = GetSingle("SELECT Nombre, Proveedor, ClienteAsociado, AceptaCheques FROM Proveedor WHERE Proveedor = '" & txtProveedor.Text & "'") '_TraerDatosProveedor(txtProveedor.Text)
