...
Public Class AgregarArchivosEvalProvMP

    Private ReadOnly WProveedor As String
    Private ReadOnly WMP As String
    Private ReadOnly WReq As String
    Private ReadOnly WPath

    Private Const EXTENSIONES_PERMITIDAS = "*.bmp|*.png|*.jpg|*.jpeg|*.pdf|*.doc|*.docx|*.xls|*.xlsx"

    Sub New(ByVal Proveedor As String, ByVal MP As String, ByVal Req As String, Optional ByVal Habilitado As Boolean = True)
        ...
        WMP = MP
        WReq = Req.PadLeft(2, "0")

        WPath = ConfigurationManager.AppSettings("PATH_DOCS_EVAL_PROV_MP") & WProveedor & "/" & WMP & "/" & WReq
