...
Public Class ListadoMinutas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agenda_Gestión_Reclamos_Envases.ListadoMinutas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoMinutas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoMinutas = New ListadoMinutas()
        rpt.Site = Me.Site
        Return rpt
    End Function
